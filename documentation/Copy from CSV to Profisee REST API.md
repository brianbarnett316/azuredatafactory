Copy CSV Format to Profisee REST API
====================================
...
> <img src="./media/copyfrom_csv_to_restapi_2.png" style="width:2.1859in;height:1.49693in" />

1.  Create a **New** or use an existing connection to the ADLS Gen2
    source data store that you are copying data from.

> <img src="./media/copyfrom_csv_to_restapi_3.png" style="width:5.68712in;height:3.02766in" />

1.  Create a **New** or use an existing connection to the sink Profisee
    REST API.

> <img src="./media/copyfrom_csv_to_restapi_4.png" style="width:5.63804in;height:3.00153in" />

1.  Follow these steps if you need to create a new REST linked service.

2.  Select “+ New" from the **REST** dropdown list.

> <img src="./media/copyfrom_csv_to_restapi_5.png" style="width:2.06135in;height:1.29089in" />
...
> <img src="./media/copyfrom_csv_to_restapi_6.png" style="width:3.54601in;height:3.93413in" />

1.  Select **Use this template**.

> <img src="./media/copyfrom_csv_to_restapi_7.png" style="width:5.61963in;height:3.33576in" />

1.  You will see a pipeline created as shown in the following example:

> <img src="./media/copyfrom_csv_to_restapi_8.png" style="width:4.04838in;height:2.96319in" />
>
> You should also see the following template validation output.
>
> <img src="./media/copyfrom_csv_to_restapi_9.png" style="width:3.02985in;height:0.64356in" />
>
...
> <img src="./media/copyfrom_csv_to_restapi_10.png" style="width:2.67485in;height:2.51343in" />
...
> <img src="./media/copyfrom_csv_to_restapi_11.png" style="width:4.14925in;height:1.38885in" />

1.  The EntityName.

> <img src="./media/copyfrom_csv_to_restapi_12.png" style="width:4.19403in;height:1.2376in" />
...
> <img src="./media/copyfrom_csv_to_restapi_13.png" style="width:3.0184in;height:1.78387in" />

1.  The Source dataset properties are set from the two pipeline
    parameters.

> <img src="./media/copyfrom_csv_to_restapi_14.png" style="width:4.11043in;height:1.77328in" />
...
> <img src="./media/copyfrom_csv_to_restapi_15.png" style="width:4.58955in;height:2.12855in" />
...
> <img src="./media/copyfrom_csv_to_restapi_16.png" style="width:4.42616in;height:6.45399in" />

1.  Click **Continue** on the **Data preview** page.

> <img src="./media/copyfrom_csv_to_restapi_17.png" style="width:3.63634in;height:2.8773in" />

1.  Enter the following **Trigger Run Parameters**

> <img src="./media/copyfrom_csv_to_restapi_18.png" style="width:4.10067in;height:2.79949in" />

1.  Once you are finished with all your changes, click Publish All.

> <img src="./media/copyfrom_csv_to_restapi_19.png" style="width:1.36994in;height:0.29043in" />
...
> <img src="./media/copyfrom_csv_to_restapi_20.png" style="width:3.63804in;height:1.45401in" />
>
> <img src="./media/copyfrom_csv_to_restapi_21.png" style="width:4.88957in;height:0.50724in" />
...
> <img src="./media/copyfrom_csv_to_restapi_22.png" style="width:5.68098in;height:1.07854in" />
...
>
> <img src="./media/copyfrom_csv_to_restapi_23.png" style="width:4.0698in;height:1.8875in" />
